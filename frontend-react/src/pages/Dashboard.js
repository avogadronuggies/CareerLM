            ...
            <div className="welcome-card">
                ...
                {resumeData ? (
                  <div className="resume-status success">
                    ...
                    <div className="status-text">
                      ...
                      <p className="status-subtitle">Latest file: {resumeData.filename}</p>
                    </div>
                  </div>
                ) : (
                  <div className="resume-status pending">
                    ...
                    <div className="status-text">
                      ...
                      <p className="status-subtitle">Click "Upload Resume" to get started</p>
                    </div>
                  </div>
                )}
              </div>
              <div className="quick-actions">
                ...
                <div className="actions-grid">
                  <button className="action-card" onClick={() => setCurrentPage("upload")}>
                  ...
                  <button className="action-card" onClick={() => setCurrentPage("resume_optimizer")}>
                    <div className="action-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <button className="action-card" onClick={() => setCurrentPage("skill_gap")}>
                    <div className="action-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <button className="action-card" onClick={() => setCurrentPage("mock_interview")}>
                    <div className="action-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
